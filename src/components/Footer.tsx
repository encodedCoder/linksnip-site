...
export default function Footer() {
  ...
  return (
    <motion.footer
      className="relative z-10 mt-auto py-8"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ delay: 0.5, duration: 0.5 }}
    >
      <div className="max-w-5xl mx-auto px-4">
        <div className="relative rounded-2xl overflow-hidden backdrop-blur-md border border-white/20 bg-white/5">
          ...
          <div className="relative z-10 px-6 py-8">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
              ...
              <div className="flex flex-wrap justify-center gap-x-8 gap-y-2">
                ...
                <FooterLink href="/my-links" label="My Links" />
            ...
            <div className="flex flex-col md:flex-row justify-between items-center text-white/60 text-sm">
              <div>
                Copyright © {currentYear} encodedcoder · Suresh. All rights
                reserved.
              </div>
...
function ProfileLink() {
  ...
  // Reset pulsing animation when user returns to page
  useEffect(() => {
    ...
    // Stop pulsing after 5 seconds on initial load
  ...
  return (
    <motion.div
      className="order-first md:order-none mx-auto md:mx-0"
      whileHover={{ scale: 1.05 }}
      transition={{ type: "spring", stiffness: 400, damping: 10 }}
    >
      <motion.a
        ...
        className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-600 text-white font-medium shadow-lg hover:shadow-indigo-500/30 transition-all"
        whileHover={{
